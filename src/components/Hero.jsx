          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative">
                <div className="w-full h-64 md:h-72 lg:h-80 rounded-2xl bg-gradient-to-br from-[#001021] to-[#08102a] border border-white/5 p-4">
                  <div className="w-full h-full rounded-xl bg-[linear-gradient(135deg,#00101a,#041225)] p-6 flex flex-col justify-between">
